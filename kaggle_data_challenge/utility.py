...
def show_reg_result_single_run(y_true, y_pred, axes, suffix='training', threshold=3):
    ...
    print(f'{suffix} performance, mean root square error is: ' + str(mean_squared_error(y_true, y_pred)))
...
if __name__ == '__main__':
    ...
    # Read data.
    base_dictionary = 'C:/Users/Zhiguo/OneDrive - CentraleSupelec/Code/Python/digital_twin_robot/projects/maintenance_industry_4_2024/dataset/data/training_data/'
